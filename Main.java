...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Aircraft airbus = new Aircraft("Airbus A320", 150);

        Airline egyptAir = new Airline("EgyptAir");
        egyptAir.addAircraft(boeing);
        egyptAir.addAircraft(airbus);

        egyptAir.displayFleet();
        // ====== Create Demo Data ======
        ...
        Agent agent = new Agent("A001", "agent007", "secret77", "Khaled Amin", "khaled@agent.com", "01555555555", "A001", "Sales", 1000.0, system);
        Administrator admin = new Administrator("AD001", "admin1", "admin88pass", "Laila Mohamed", "laila@admin.com", "01333333333", "AD001", "High");
        Customer customer2 = new Customer("C002", "mona22", "pass456", "Mona Adel", "mona@gmail.com", "01222222222", "C002", "Alexandria", new ArrayList<>(), system);
        Agent agent2 = new Agent("A002", "agent008", "topmmm9", "Hossam Fathy", "hossam@agent.com", "01666666666", "A002", "Support", 1200.0, system);
        Administrator admin2 = new Administrator("AD002", "admin2", "admin99key", "Nadia Ibrahim", "nadia@admin.com", "01444444444", "AD002", "Medium");
       ...
       // FileManager.savePassengersToFile(passengers);
        ...
        bookings.add(new Booking("B001", customer, flight1));
        bookings.add(new Booking("B002", customer, flight2));
        bookings.add(new Booking("B003", customer, flight3));
        bookings.add(new Booking("B004", customer, flight1));
        bookings.add(new Booking("B005", customer, flight1));
        bookings.add(new Booking("B006", customer, flight1));
    ...
    static void handleCustomerMenu(Customer cust, BookingSystem system, Scanner sc) {
        while (true) {
            ...
            System.out.println("6.View Ticket (GUI)");
            System.out.print("Choose: ");
            int ch = getInt(sc);
                ...
                try {
                    ...
                    try {
                        ...
                        PaymentMethod method = (pm == 1) ?
                                ...
                                new BankTransferPayment("1234567890", "CIB", "SWIFT001");

                        Payment p = new Payment("P" + System.currentTimeMillis(), booking, "EGP", method);
                        system.processPayment(booking, p);
                        booking.printItinerary();

                        // حفظ الحجز في ملف الـ bookings.txt بعد تأكيد الدفع
                        FileManager.saveBookingsToFile(List.of(booking));  // حفظ الحجز في ملف البوكينغز
    ...
    static void handleAgentMenu(Agent agent, BookingSystem system, Scanner sc) throws IOException {
        while (true) {
            ...
            if (ch == 1) {
                // استدعاء الميثود manageFlights من كلاس Agent
                agent.manageFlights(system, sc);
            } else if (ch == 2) {
                ...
                if (u instanceof Customer) {
                    ...
                    try {
                        ...
                        // إضافة الحجز إلى ملف الـ bookings.txt
                        FileManager.saveBookingsToFile(List.of(booking));  // حفظ الحجز في ملف الـ bookings.txt
