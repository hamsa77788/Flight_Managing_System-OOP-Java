...
public class FileManager {
    ...
    public static void saveFlightsToFile(List<Flight> flights) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FLIGHTS_FILE, false))) { // Change to false if you want to overwrite
        ...
        System.out.println(flights.size() + " flights saved to file.");
    }
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 6) {
                    try {
                        ...
                        System.out.println("Error parsing date/time for flight: " + line);
                    }
                }
            }
        }
        System.out.println(flights.size() + " flights loaded from file.");
        return flights;
    }
